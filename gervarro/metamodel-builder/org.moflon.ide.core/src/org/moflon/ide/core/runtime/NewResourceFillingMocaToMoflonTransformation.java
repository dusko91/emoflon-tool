...
public class NewResourceFillingMocaToMoflonTransformation extends BasicResourceFillingMocaToMoflonTransformation {
   private Map<String, MetamodelProperties> propertiesMap;

   private IProgressMonitor monitor;

   public NewResourceFillingMocaToMoflonTransformation(final ResourceSet resourceSet,
