 ...
 */
public class CodeGen2TextEditorConfiguration extends MoflonTextEditorConfiguration {
  ...
  /**
   * This method returns a collection of templates when user presses ctrl+space 
   * in a text editor. With the help of getWord(int) method, the context from 
   * the cursor position can be accessed.
   */
  public Collection<MoflonEditorTemplate> getTemplates() {
    ...
    // MoflonEditorTemplate methodSignatureTemplate = new MoflonEditorTemplate(
