...
public class ContikiCodeGenerator {
	...
	public IStatus generateCode(IProgressMonitor eclipseSubProgress) {
		...
		generateHeader(component, algorithmName, null, fields, methods,
				CMoflonWorkspaceHelper.createSubmonitorWith1Tick(eclipseSubProgress));
	...
	protected void generateSourceFile(String component, String algorithmName, String generatedCode,
		...
		try {
			CMoflonWorkspaceHelper.addFile(project,
					CMoflonWorkspaceHelper.GEN_FOLDER + "/" + filename + ".c", contents,
					CMoflonWorkspaceHelper.createSubmonitorWith1Tick(iProgressMonitor));
	...
	protected void generateHeader(String componentName, String algorithmName, EList<EOperation> operations,
		...
		try {
			CMoflonWorkspaceHelper.addFile(project,
					CMoflonWorkspaceHelper.GEN_FOLDER + "/" + componentName + "-" + algorithmName + ".h",
					contents, CMoflonWorkspaceHelper.createSubmonitorWith1Tick(monitor));
		} catch (CoreException e) {
