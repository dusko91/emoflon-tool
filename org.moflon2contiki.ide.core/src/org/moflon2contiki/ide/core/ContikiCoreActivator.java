package org.moflon2contiki.ide.core;
 ...
 */
public class ContikiCoreActivator extends AbstractUIPlugin {
	...
	// The shared instance
	private static ContikiCoreActivator plugin;
	 ...
	 */
	public static ContikiCoreActivator getDefault() {
		return plugin;
	}
