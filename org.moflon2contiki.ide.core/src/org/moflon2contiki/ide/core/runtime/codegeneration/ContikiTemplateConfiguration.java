...
import org.moflon2contiki.ide.core.runtime.codegeneration.utilities.ControlFlowModelAdaptor;
import org.moflon2contiki.ide.core.runtime.codegeneration.utilities.Moflon2ContikiEcoreModelAdaptor;
import org.moflon2contiki.ide.core.runtime.codegeneration.utilities.PatternMatcherModelAdaptor;
import org.stringtemplate.v4.STGroup;

/**
 * Mimics behaviour of {@link DefaultTemplateConfiguration}. <br>
 * Includes the changed StringTemplates as well as the {@link ContikiStringRenderer}
...
public class ContikiTemplateConfiguration implements TemplateConfigurationProvider {
	...
	public ContikiTemplateConfiguration(GenModel genModel) {
	     ...
	     final EcoreModelAdaptor ecoreModelAdaptor = new Moflon2ContikiEcoreModelAdaptor(ecoreToGenModelConverter);
		
		 final STGroup controlFlowTemplateGroup = createControlFlowTemplates();
		 controlFlowTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	     ...
	     final STGroup bindingAndBlackTemplateGroup = createBindingAndBlackTemplates();
	      ...
	      bindingAndBlackTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	      ...
	      bindingTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	      ...
	      blackTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	      ...
	      redTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	      ...
	      greenTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	      ...
	      expressionTemplateGroup.registerRenderer(String.class, new ContikiStringRenderer());
	...
	public static final STGroup createRedTemplates()
	   {
	      ...
	      group.registerRenderer(String.class, new ContikiStringRenderer());
	 ...
	 @SuppressWarnings("unchecked")
	   ...
	   {
	      return "platform:/plugin/" + ContikiCoreActivator.getModuleID() + "/templates/";
	   }
}
