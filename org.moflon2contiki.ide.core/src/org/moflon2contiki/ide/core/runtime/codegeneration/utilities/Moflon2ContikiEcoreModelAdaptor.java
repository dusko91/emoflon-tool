package org.moflon2contiki.ide.core.runtime.codegeneration.utilities;
 ...
 *
 */
public class Moflon2ContikiEcoreModelAdaptor extends EcoreModelAdaptor {

	public Moflon2ContikiEcoreModelAdaptor(EcoreToGenModelConverter converter) {
		super(converter);
