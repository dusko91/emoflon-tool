...
public class MoflonSourceViewerConfiguration extends SourceViewerConfiguration
{
   ...
   public MoflonSourceViewerConfiguration(IProject selectedProject, IResource resource, MoflonTextEditorConfigIntern moflonTextEditorConfiguration,
         MoflonTextEditor editor)
   {
   ...
   private void configureTextEditorBuilder(IProject selectedProject, IResource resource, MoflonTextEditor editor)
   {
