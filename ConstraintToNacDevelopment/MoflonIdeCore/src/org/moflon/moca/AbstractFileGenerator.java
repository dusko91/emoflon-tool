...
public abstract class AbstractFileGenerator
{
   ...
   protected void addFileAndCheckSuccess(String fileName, String content) throws CoreException
   {
   ...
   protected boolean addFile(String fileName, String content) throws CoreException
   {
